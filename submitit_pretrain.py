...
def parse_args():
    ...
    parser.add_argument("--folder", default="", type=str, help="folder dir. Leave empty for automatic.")
...
def get_shared_folder() -> Path:
    ...
    if Path("/checkpoint/").is_dir():
        p = Path(f"/checkpoint/{user}/experiments/dpcap/")
...
def main():
    ...
    if args.job_dir == "":
        if args.folder=="":
            ...
            args.job_dir = get_shared_folder() / args.folder
    elif args.folder=="":
        args.job_dir =  Path(args.job_dir) / "%j"
    else:
        args.job_dir =  Path(args.job_dir) / args.folder
